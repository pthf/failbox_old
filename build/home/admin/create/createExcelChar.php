<?php
	require_once("../db/conexion.php");
		...
		$objPHPExcel->getProperties()->setCreator("Failbox") //Autor
							 ...
							 ->setTitle("Listado Características de los Productos")
							 ->setSubject("Carga Masiva")
							 ->setDescription("Tablas necesarias para los productos")
							 ->setKeywords("reporte características")
							 ->setCategory("Reporte excel");

		$tituloReporte = "Características Failbox";
		$titulosColumnas = array('IDCARACTERISTICA', 'CARACTERISTICA');
		...
		$objPHPExcel->getActiveSheet()->setTitle('Caracteristicas');
		...
		header('Content-Disposition: attachment;filename="caracteristicas.xls"');
